...
{
    public class ProductControllerInMemory : ProductControllerBaseTest
    {
        public ProductControllerInMemory()
        {
            SetContextOptions(new DbContextOptionsBuilder<UdemyRealWorldUnitTestContext>()
                                .UseInMemoryDatabase("UdemyRealWorldUnitTestInMemoryDB").Options);
        }
