...
namespace UdemyRealWorldUnitTest.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(UdemyRealWorldUnitTestContext context)
        {
            _context = context;
        }
        ...
        {
            var udemyRealWorldUnitTestContext = _context.Products.Include(p => p.Category);
            return View(await udemyRealWorldUnitTestContext.ToListAsync());
        }
